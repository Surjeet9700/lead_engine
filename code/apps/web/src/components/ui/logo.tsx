...
export function Logo({
	...
	return (
		<div className={cn("inline-flex items-center gap-2.5 font-semibold", className)} {...props}>
			{/* Axis Geometric Icon Mark - Pure Monochrome */}
			<div className="relative flex size-8 shrink-0 items-center justify-center rounded-lg border border-border/80 bg-muted/60 text-foreground">
				<svg
					width="18"
					height="16"
					viewBox="0 0 24 21"
			...
			{showWordmark && (
				<div className="flex flex-col text-left">
					<div className="flex items-center gap-1.5">
						...
						<span className="rounded bg-muted px-1.5 py-0.2 text-[9px] font-medium text-muted-foreground border border-border/80">
							CRM
						</span>
					</div>
