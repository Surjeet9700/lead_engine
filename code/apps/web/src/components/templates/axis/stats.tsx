...
const Stats = () => {
	const stats = [
		...
		{
			name: "Higher Deal Conversion",
			value: 3,
			suffix: "x",
		},
		{
			name: "BuyLead Dispute Recovery",
			value: 100,
			suffix: "%",
		},
	];
		...
		>
			<div className="mb-16 flex flex-col items-center gap-3 px-4 text-center">
				...
				<p className="max-w-md text-sm text-muted-foreground sm:text-base">
					Every second lost is a deal won by your competitor. Dominate your industrial market with sub-45s velocity.
				</p>
			</div>
